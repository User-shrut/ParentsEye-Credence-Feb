...
const Export = ({ filteredRows, columnVisibility, COLUMNS, pdfTitle, pdfFilename, excelFilename, orangeBtn, prevColor}) => {
  ...
  return (
    <div>
      <Button onClick={handleClick} variant="contained"  style={orangeBtn ? orangeBtn : prevColor ? prevColor : { backgroundColor: "#d32f2f", color: "white", marginRight:'5px' }} aria-haspopup="true" aria-label="Export options">
        Export
      </Button>
